...
//Local Imports
import HiddenArsenalBanlistLable from "./HiddenArsenalBanlistLable.js";
...
import hiddenarsenalbanlist from "../../public/hiddenarsenalbanlist.json";

export default function HiddenArsenalBanlistSemiLimited() {
  console.log(hiddenarsenalbanlist.data);
  const [data] = useState([]);

  hiddenarsenalbanlist.data.sort(function (a, b) {
      ...
      <Card>
        <Card.Body>
          ...
          <div className="user-container">
            <Table bordered>
              <HiddenArsenalBanlistLable />
              <tbody>
                {data
                  ? hiddenarsenalbanlist.data
                      .filter(
                        (card) =>
